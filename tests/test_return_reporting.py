...
def test_period_return_includes_zero_trade_weekdays() -> None:
    start = datetime(2026, 8, 3, tzinfo=UTC)  # Monday
    end = datetime(2026, 8, 10, tzinfo=UTC)  # next Monday, five weekdays
    values = (
...
def test_empty_period_has_zero_return_but_preserves_period_denominator() -> None:
